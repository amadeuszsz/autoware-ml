...
def test_seg_class_mapping_maps_final_names_to_index() -> None:
    mapping = seg_class_mapping(_NAME_MAPPING, _CLASS_NAMES, ignore_index=-1)
...
def test_seg_class_mapping_sends_null_and_unknown_finals_to_ignore() -> None:
    mapping = seg_class_mapping(_NAME_MAPPING, _CLASS_NAMES, ignore_index=-1)
