"""Confident-error rate (metric E3).
...
(prediction disagrees with ground truth, no class partitioning), E3 reports the
fraction made at high confidence, i.e. low predictive entropy. Like D1, the area
