...
prediction and therefore no score, so the missed-object (safety) axis is B1's
critical-FN. It reads the score-ordered false-positive flags already on the match
